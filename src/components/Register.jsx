...
import { USER_REGEX, PWD_REGEX } from "../utils/regexs";
import { REGISTER_URL } from "../utils/urlList";
...
const Register = () => {
  ...
  //to put focus on error if any, for accessibility
  const errRef = useRef();
    ...
    <>
      {success ? (
        <section>
          ...
          <p>you will be redirected to login screen in few seconds.</p>
        </section >
      ) : (
        <section>
          <p
